...
from grindhouse.pagination import ResultsSetPagination
...
def root(request, format=None):
    return Response(
        [
            {'Public': OrderedDict([
                ('Activate', reverse('grindhouse:activate',
                    request=request,
                    format=format)),
                ('Deactivate', reverse('grindhouse:deactivate',
                    request=request,
                    format=format))
            ])},
            {'Admins': OrderedDict([
                ('Company', reverse('grindhouse:admin-company',
                    request=request,
                    format=format)),
                ('Currencies', reverse('grindhouse:admin-currencies',
                    request=request,
                    format=format))
            ])},
        ])
